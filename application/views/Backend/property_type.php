                           ...
                           $i = 1;
                            foreach ($get_datas as $member) {
                              ...
                              <tr class="odd gradeX" data-id="<?=$member->id;?>">
                                ...
                                <td class="center">   <?=$member->property_type; ?></td>
  ...
  <!-- Add  Testimonial-->
	        ...
	        <div class="modal-header">
              ...
              <div class="modal-body">
               <div class="row ">
                ...
                <label for="inputName" class="form-label">Property Type<span class="error">* </span></label>
                <input type="text" name="property_type" data-required="1" placeholder="Property Type" class="form-control" id="property_type" required /> 
                </div>
	...
	<div class="modal fade" id="Editverticalycentered" tabindex="-1">
	    <div class="modal-dialog modal-dialog-centered ">
	      ...
	      <div class="modal-content">
	        <div class="modal-header">
	          <h5 class="modal-title">Update Property Type</h5>
	          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
	        </div>
 ...
 $(document).on('click','#save_member',function(){
        event.preventDefault();
           ...
           if( $("#city").val() != ''  ){ 
            ...
            $.ajax({
            type:'post',
            url: '<?php echo base_url("Dashboard/addProperty_type");?>',
     ...
     $(document).ready(function() {
            $('#testimonial-table').on('click', '.tblEditBtn', function() {
               ...
               // $('.modal-title').text("Edit Banner")
                ...
                $.ajax({
                    url: '<?php echo base_url("Dashboard/getProperty_typeByID"); ?>?id=' + id, // Adjust the URL to match your product retrieval endpoint
                    method: 'GET',
                    //data: { id: id },
                    dataType: 'json',
                    success: function(response) {
                        ...
                        $('#Editverticalycentered [name="property_type"]').val(response.property_type);
         ...
         $(document).on('click','#update_member',function(){
                ...
                $.ajax({
                type:'post',
                url: '<?php echo base_url("Dashboard/updateProperty_type");?>',
       ...
       $.confirm({
        ...
        $.ajax({
        type: 'post',
        url: '<?php echo base_url('Dashboard/DeleteProperty_type') ?>',
        data: {id:id},
        success: function (response) {
